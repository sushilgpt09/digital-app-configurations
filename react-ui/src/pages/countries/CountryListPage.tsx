...
export function CountryListPage() {
  ...
  return (
    <div>
      <PageHeader title="Country Master" action={<button onClick={() => { setEditingItem(null); setShowForm(true); }} className="flex items-center gap-2 px-5 py-2.5 bg-[#5C90E6] text-white rounded-lg hover:bg-[#4A7DD4] transition-colors"><Plus size={18} /> Add Country</button>} />
