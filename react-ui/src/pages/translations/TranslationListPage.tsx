...
export function TranslationListPage() {
  ...
  return (
    <div>
      <PageHeader title="Translation Management" action={<button onClick={() => { setEditingItem(null); setShowForm(true); }} className="flex items-center gap-2 px-5 py-2.5 bg-wing-info text-white rounded-lg hover:bg-blue-600"><Plus size={18} /> Add Translation</button>} />
