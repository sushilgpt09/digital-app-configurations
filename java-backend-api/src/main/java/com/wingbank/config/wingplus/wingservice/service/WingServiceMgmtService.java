...
public interface WingServiceMgmtService {
    PagedResponse<WingServiceResponse> getAll(String categoryId, String status, int page, int size);
    ...
    void delete(UUID id);
    List<WingServiceResponse> getActiveByCategory(UUID categoryId);
}
